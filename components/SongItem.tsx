...
const SongItem = ({ data, onClick }: SongItemProps) => {
  ...
  return (
    <div
      ...
      className="group relative flex cursor-pointer flex-col items-center gap-x-4 overflow-hidden rounded-md bg-neutral-400/5 p-3 transition hover:bg-neutral-400/10"
    >
      ...
      <div className="flex w-full flex-col items-center gap-y-1 pt-4">
